...
const char D_INTRO_0[] PROGMEM = "Wifi Deauther";
const char D_INTRO_1[] PROGMEM = "by Yeshwanth.ECE";
const char D_INTRO_2[] PROGMEM = DISPLAY_TEXT;
const char D_RESETTING[] PROGMEM = "Resetting...";
const char D_SCANNING_0[] PROGMEM = "> YNS.";
const char D_SCANNING_1[] PROGMEM = "> YNS..";
const char D_SCANNING_2[] PROGMEM = "> Hecatroncis...";
const char D_SCANNING_3[] PROGMEM = "> Hecatroncis....";
